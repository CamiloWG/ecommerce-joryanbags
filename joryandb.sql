...
INSERT [dbo].[products] ([product_id], [name], [brand], [price], [stock], [category_id], [code], [date_creation], [image_url], [is_disabled]) VALUES (1, N'Bolso Rojo', N'Joryan', CAST(30000.00 AS Decimal(10, 2)), 5, 1, NULL, CAST(N'2025-03-30T23:33:09.757' AS DateTime), N'/public/product_1.png', 0)
INSERT [dbo].[products] ([product_id], [name], [brand], [price], [stock], [category_id], [code], [date_creation], [image_url], [is_disabled]) VALUES (2, N'Bolso Morado', N'Joryan', CAST(25000.00 AS Decimal(10, 2)), 2, 1, NULL, CAST(N'2025-03-31T00:10:21.987' AS DateTime), N'/public/product_2.png', 0)
INSERT [dbo].[products] ([product_id], [name], [brand], [price], [stock], [category_id], [code], [date_creation], [image_url], [is_disabled]) VALUES (1002, N'Bolso Rojo', N'Joryan', CAST(20000.00 AS Decimal(10, 2)), 5, 1, NULL, CAST(N'2025-03-28T20:40:32.560' AS DateTime), N'/public/product_14.png', 0)
INSERT [dbo].[products] ([product_id], [name], [brand], [price], [stock], [category_id], [code], [date_creation], [image_url], [is_disabled]) VALUES (1003, N'Bolso Morado', N'Joryan', CAST(30000.00 AS Decimal(10, 2)), 5, 1, NULL, CAST(N'2025-03-28T21:21:24.867' AS DateTime), N'/public/product_15.png', 0)
INSERT [dbo].[products] ([product_id], [name], [brand], [price], [stock], [category_id], [code], [date_creation], [image_url], [is_disabled]) VALUES (1004, N'Bolso Negro', N'Joryan', CAST(50000.00 AS Decimal(10, 2)), 5, 1, NULL, CAST(N'2025-03-28T21:22:11.523' AS DateTime), N'/public/product_16.png', 0)
INSERT [dbo].[products] ([product_id], [name], [brand], [price], [stock], [category_id], [code], [date_creation], [image_url], [is_disabled]) VALUES (1005, N'Bolso Cafe', N'Joryan', CAST(43000.00 AS Decimal(10, 2)), 10, 1, NULL, CAST(N'2025-04-02T16:26:16.833' AS DateTime), N'/public/product_1002.png', 0)
INSERT [dbo].[products] ([product_id], [name], [brand], [price], [stock], [category_id], [code], [date_creation], [image_url], [is_disabled]) VALUES (1006, N'Bolso Purpura', N'Joryan', CAST(36000.00 AS Decimal(10, 2)), 10, 1, NULL, CAST(N'2025-04-02T16:27:05.690' AS DateTime), N'/public/product_1003.png', 0)
